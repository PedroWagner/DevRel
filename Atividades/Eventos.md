...
<br>
  <br>
&nbsp;&nbsp;Como dito anteriormente, eventos costumam preferir participantes já conhecidos então é possível que seja rejeitado com frequência no início, em particular por eventos maiores. Para aumentar suas chances de sucesso, você deve trabalhar para aumentar seu renome, do seu time e sua empresa.
<br>
  <br>
...
<br>
  <br>
&nbsp;&nbsp;&nbsp;&nbsp;Normalmente, eventos costumam cobrir as despesas de viagem e acomodação dos palestrantes, e esta é uma cortesia profissional que você tem o direito de esperar e exigir. Entretanto, no início da sua carreira ou em oportunidades imperdíveis, talvez não valha a pena argumentar se não te oferecerem, e então você terá que pagar você mesmo. Entretanto, nunca pague para dar uma palestra, e evite patrocínios que possam te forçar a falar algo que não acredita. Isso compromete sua reputação e integridade, que são valiosas demais neste ramo.
<br>
  <br>
</details>
...
<br>
  <br>
&nbsp;&nbsp;&nbsp;&nbsp;Monte sua cabine com o material de marketing da sua empresa, como estandartes, panfletos, souvenires, etc. Tenha também uma demonstração do seu produto e sempre pelo menos uma pessoa da equipe presente e atenta.
<br>
  <br>
&nbsp;&nbsp;&nbsp;&nbsp;Tenha com você cartões de negócio para distribuir aos interessados, e guarde os cartões que receber. Assista às palestras de outros apresentadores, e dê uma passada em outras cabines, converse com as pessoas que as gerenciam. Isto não só demonstra respeito e interesse pelos seus colegas, como te dá informações preciosas sobre o que está acontecendo no mercado.
<br>
  <br>
...
<br>
  <br>  
&nbsp;&nbsp;&nbsp;&nbsp;Por fim, você pode reaproveitar sua ida à conferência como conteúdo, escrevendo de forma mais profunda sobre sua experiência ou sobre sua palestra (Mais sobre isso no <a href="https://pedrowagner.github.io/DevRel/Atividades/Conteudo">capítulo “Produzir Conteúdo”</a>).
<br>
  <br>  
</details>
...
<br>
  <br>  
&nbsp;&nbsp;&nbsp;&nbsp;No seu roteiro, procure evitar frases como “Isto é fácil”, “qualquer um consegue”, ou “todo mundo sabe que...” entre outras. Este tipo de linguagem pode parecer encorajador, mas simplesmente irá fazer com que partes de sua plateia se sintam mal por não conseguirem ou saberem o que você dizer ser tão simples. Dê uma relida no seu roteiro e procure substituir frases como essas.
<br>
  <br>  
&nbsp;&nbsp;&nbsp;&nbsp;Com seu roteiro pronto, você precisa praticá-lo. Leia-o em voz alta umas cinco vezes, e depois recite-o o mesmo número de vezes sem ler. Você precisa estar confiante na sua capacidade de reproduzir seu texto, especialmente se tiver medo de palco. É importante ler em voz alta, por que o que parece bom quando escrito, não necessariamente soa bem falado. Enquanto pratica, você pode ter ideias espontâneas para piadas ou anedotas. Então anote-as e vá ajustando seu roteiro a medida que pratica.
<br>
  <br>  
&nbsp;&nbsp;&nbsp;&nbsp;Depois de recitar algumas vezes, faça de novo cronometrando seu tempo. Você provavelmente saberá de antemão qual o seu tempo para falar, e precisa manter-se nele. É comum que a palestra de verdade dure mais do que seu ensaio, por diversos motivos, então talvez seja melhor tentar se manter em um tempo dez por cento menor que o real. Para isso, você talvez tenha que passar por outra etapa de edição para reduzir o tamanho do texto. Uma tática para fazer isso é “delegar” a informação. Ao invés de explicar o que algo não essencial significa, aponte para um recuso que o público possa acessar para aprender.
<br>
  <br>  
&nbsp;&nbsp;&nbsp;&nbsp;Por fim, passe seu roteiro por um teste. Chame uma ou mais pessoas de confiança e apresente sua palestra para elas. Pergunte o que acharam, se ficaram interessadas, e o que não entenderam, e ajuste seu roteiro com base nisso. Também grave seus ensaios e reveja-os depois. Isso te ajudará a se ouvir e perceber tiques, pausas muito longas, etc.
<br>
  <br>  
&nbsp;&nbsp;&nbsp;&nbsp;Tudo isto estando feito, seu roteiro está pronto para a conferência.
<br>
  <br>    
</details>
<details>
...
<br>
  <br>    
&nbsp;&nbsp;&nbsp;&nbsp;Para preparar um deck de slides, faça uma lista de pontos com os tópicos que irá discutir segundo o seu roteiro. Cada ponto desta lista será um slide ou um grupo de slides. Adicione um slide de introdução e um de conclusão, e este é o esqueleto do seu deck.
<br>
  <br>    
&nbsp;&nbsp;&nbsp;&nbsp;Adicione ainda um slide, primeiro de todos, em que se apresenta, e neste slide, coloque suas informações de contato e redes sociais, e um link para a Central do Desenvolvedor. Faça o mesmo no último slide. De preferência, coloque isso como um QR code, que permitirá que a plateia se conecte assim que a palestra acaba, e te permite ter informações detalhadas de quantos usaram.
<br>
  <br>    
&nbsp;&nbsp;&nbsp;&nbsp;Para fazer o design dos seus slides, use uma fonte grande com forte contraste entre o texto e o fundo. Projetores em conferências frequentemente são ruins e tornarão textos difíceis de ler em praticamente invisíveis. Crie um estilo visual consistente, usando uma paleta de cores chamativa e atraente em todos os slides. Procure manter as cores constantes por todo o deck, mas você pode invertê-las em um slide de transição ou um muito importante, pois esta troca súbita chama atenção. Por exemplo, texto branco em fundo laranja na maioria dos slides, mas texto laranja em fundo branco para um slide de impacto.
<br>
  <br>    
&nbsp;&nbsp;&nbsp;&nbsp;Use imagens que ilustram o sentido do que você fala. Estes podem ser gráficos e diagramas, uma foto do que você está falando ou simplesmente uma que ilustre um conceito abstrato. Ao procurar imagens na internet, tome cuidado para obter as permissões necessárias, e credite o fotógrafo em seus slides.
<br>
  <br>    
&nbsp;&nbsp;&nbsp;&nbsp;Fora isso, as melhores dicas para um bom deck de slides são uma lista do que não fazer. Não use mais de uma frase de texto por slide;  a plateia deve estar ouvindo você e não lendo a tela. Não use efeitos de transições entre slides; eles apenas distraem. Não use vídeos com áudio; eles nem sempre funcionam bem, e te colocam em posição de espectador. Se realmente quiser ou precisar usar um vídeo com áudio, guarde-o para o final, de forma a não interromper o fluxo da sua apresentação. Se usar vídeo, tome cuidado para não usar autoplay, pois isso pode te atrapalhar na hora de falar.
<br>
  <br>    
&nbsp;&nbsp;&nbsp;&nbsp;Quando tiver seu deck pronto, você pode dividir seu roteiro em pequenas anotações e associá-las aos respectivos slides usando as “Speaker Notes”, uma funcionalidade presente em todos os grandes programas de slides, que te permite adicionar um texto secreto a um slide.
<br>
  <br>  
</details>
<details>
...
<br>
  <br> 
&nbsp;&nbsp;&nbsp;&nbsp;Pergunte aos organizadores do evento se é possível ensaiar antes da palestra. Pergunte também se você pode gravar uma palestra com a própria câmera. Normalmente, as conferências já gravam as palestras, mas as gravações podem demorar muito a serem disponibilizadas, e você se beneficiará muito por ter a sua própria o mais rápido possível. Grave também a tela do seu computador, para ter um registro dos slides e das transições junto com o vídeo e áudio.
<br>
  <br> 
...
<br>
  <br>  
&nbsp;&nbsp;E também é mais importante conhecer bem o produto, e ter uma equipe igualmente capaz, para que possa monitorar e ajudar todos os competidores usando seu produto em tempo hábil. Uma boa medida é pelo menos uma pessoa para cada cem competidores. Alguns destes eventos podem durar dias ou até semanas, então é importante, em casos como este, ter uma equipe maior que possa cobrir o evento em turnos.
<br>
  <br>  
&nbsp;&nbsp;É preciso usar alguma forma de identificação clara, como uma camiseta ou boné com o logo da empresa, para que os competidores possam te reconhecer imediatamente na multidão caso precisem de ajuda. Por este mesmo motivo, mostre-se disponível. Não fique trabalhando ou falando no telefone, pois isto desencoraja os participantes de tentarem falar com você.
<br>
  <br>  
&nbsp;&nbsp;Para facilitar tanto o seu trabalho como o dos seus competidores, não faça-os depender apenas do seu suporte. Garanta que haja material para ajudar, como documentação completa e canais de suporte funcionais. Lembre-se que hackathons são atendidos por pessoas de diversos níveis de experiência.
<br>
  <br>  
&nbsp;&nbsp;Ao longo do evento você terá a chance de observar como estes devs iniciantes usam seu produto pela primeira vez. Você poderá descobrir quais obstáculos encontram, que partes não funcionam como deviam, que partes demoram em excesso, que partes são mais ou melhor utilizadas, etc. Tudo isto é informação valiosa que deve ser repassada para a empresa.
<br>
  <br>  
&nbsp;&nbsp;Ao fim do evento, chame os competidores que usaram seu produto para conversar sobre a experiência. Anote tudo que disserem para futura referência, e não se esqueça de apontar os que ficaram satisfeitos na direção da sua Central do Desenvolvedor!
<br>
  <br>  
</details>
...
<br>
  <br> 
&nbsp;&nbsp;Mencionamos que você pode usar um QR code nos seus slides para descobrir quantas pessoas o usaram para acessar seu material, mas você pode ir além disso. Use as analíticas da sua empresa para descobrir o tráfego para seu site e para sua Central, quantas pessoas te procuraram nas redes sociais, e quantos downloads, compras e inscrições ocorreram durante e depois do evento. Se comparar isso com as mesmas métricas de antes do evento, você terá uma ideia de como sua participação afetou sua empresa, Se você tiver analíticas com informações geográficas, pode ver a diferença entre atividade na região do evento e fora.
<br>
  <br> 
&nbsp;&nbsp;Entretanto, as suas impressões subjetivas talvez sejam as mais importantes para se julgar o sucesso de um evento. Pense nas pessoas com quem interagiu ao longo deste. Somente você e a sua intuição poderão dizer se estas interações foram produtivas para seus esforços.
<br>
  <br> 
&nbsp;&nbsp;Crie um relatório sobre as pessoas que conheceu pessoalmente no evento. Fale um pouco sobre o tipo de pessoas que conheceu (com informações como idade, função, onde trabalham, etc.), assuntos que surgiram com frequência nas conversas, qualidade das conversas, quais cabines fizeram mais sucesso, quais palestras foram mais interessantes, e impressões gerais do evento.
<br>
  <br> 
&nbsp;&nbsp;Anote pessoas que você considerou particularmente promissoras em termos de se tornar futuros clientes, membros da comunidade, casos de estudo, ou parceiros para sua empresa, e porque pensou isso. Anote também aquelas que deram feedback direto sobre seu produto.
<br>
  <br> 
&nbsp;&nbsp;Ter todas as informações reunidas em um relatório é uma boa maneira de tentar entender o valor que o evento trouxe para seu programa e para sua empresa.
<br>
  <br> 
</details>
...
- <input type="checkbox" name="uchk">	Você conseguiu localizar sua cabine em uma área de alto movimento?
...
**Antes do evento (Preparar demonstração de código)**
...
- <input type="checkbox" name="uchk">	Você e sua equipe estão facilmente reconhecíveis na multidão?
...
- <input type="checkbox" name="uchk">	Você verificou as hashtags do eventos em redes sociais e anotou as impressões dos atendentes?
